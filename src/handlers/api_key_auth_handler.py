...
class APIKeyAuth(LoggerMixin):
    ...
    #     Returns:
    #         Optional[APIKey]: Đối tượng API key nếu xác thực thành công
    ...
    #     # if api_key_data.expiry_date and api_key_data.expiry_date < datetime.now(timezone.utc):
    #     if api_key_data.expiry_date:
    #         expiry_date_aware = api_key_data.expiry_date.replace(tzinfo=timezone.utc) if api_key_data.expiry_date.tzinfo is None else api_key_data.expiry_date
    ...
    #     # Cập nhật thông tin organization_id trong đối tượng API key
    #     if effective_org_id and effective_org_id != api_key_data.organization_id:
    #         api_key_data.organization_id = effective_org_id
    ...
    #     Returns:
    #         Optional[APIKey]: Đối tượng API key nếu xác thực thành công và người dùng là Admin
    #     """
