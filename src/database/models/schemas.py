...
class ChatSessions(Base):
    ...
    # Định nghĩa mối quan hệ với Messages
...
class Documents(Base):
    ...
    # Định nghĩa mối quan hệ với ReferenceDocs
...
class Messages(Base):
    ...
    # Định nghĩa mối quan hệ với ChatSessions và ReferenceDocs
...
class ReferenceDocs(Base):
    ...
    # Định nghĩa mối quan hệ với Messages và Documents
